...
public class ConduitRecipes {
  ...
  public static void addRecipes() {
    ...
    if(Config.useHardRecipes) {
        ...
        addShaped(new ItemStack(EnderIO.itemPowerConduit, numConduits, 0), "b#b", "ccc", "b#b", 'c', new ItemStack(EnderIO.itemPowerConduit, 1, 0), 'b', binder, '#', conductiveIron);

        addShaped(new ItemStack(EnderIO.itemPowerConduit, numConduits, 1), "b#b", "ccc", "b#b", 'c', new ItemStack(EnderIO.itemPowerConduit, 1, 1), 'b', binder, '#', energeticGold);

        addShaped(new ItemStack(EnderIO.itemPowerConduit, numConduits, 2), "b#b", "ccc", "b#b", 'c', new ItemStack(EnderIO.itemPowerConduit, 1, 2), 'b', binder, '#', phasedGold);
